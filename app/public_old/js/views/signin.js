...
splat.Signin = Backbone.View.extend({
    ...
    signin: function(e) {
        ...
        checku.isValid ?
            splat.utils.removeValidationError('username') : splat.utils.addValidationError('username', checku.message);
        var checkp = self.model.validateItem('password');
        checkp.isValid ?
            splat.utils.removeValidationError('password') : splat.utils.addValidationError('password', checkp.message);
